...
var shoppingList2 = ["cool ranch doritos", "kings hawaiian sweet bread", "peanut butter oreos", "fruit loops cereal"];
shoppingList2.reverse()
...
var yodaTalk = ["try", "no", "is", "there", "not", "do", "or", "do"];
yodaTalk.reverse();
...
var waitList2 = ["Chance the Rapper", "Khalid", "Tay-Tay", "Barry Manilow", "Piko Taro"];
waitList2.unshift ("Kanye")
console.log(waitList2)
